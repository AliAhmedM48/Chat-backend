...
class ChatController {
    constructor() {
        this.createChat = (0, express_async_handler_1.default)((req, res, next) => __awaiter(this, void 0, void 0, function* () {
            ...
            const chat = yield chat_1.Chat.create({ name, users, lastMessage, isGroup });
            res.status(201).json({
                message: "create OK",
                chat,
            });
        }));
        this.getAllChats = (0, express_async_handler_1.default)((req, res, next) => __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            let chats = yield chat_1.Chat.find({ _id: id });
            if (chats.length === 0) {
                chats = yield chat_1.Chat.find({ users: id });
            }
