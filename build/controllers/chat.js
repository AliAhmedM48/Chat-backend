...
class ChatController {
  constructor(service) {
    ...
    this.createGroup = (0, express_async_handler_1.default)((req, res, next) =>
      __awaiter(this, void 0, void 0, function* () {
        ...
        res
          ...
          .json({ message: "create OK", chat });
      })
    );
    this.getByUserIdOrByChatId = (0, express_async_handler_1.default)(
      (req, res, next) =>
        __awaiter(this, void 0, void 0, function* () {
    ...
    this.updateChat = (0, express_async_handler_1.default)((req, res, next) =>
      __awaiter(this, void 0, void 0, function* () {
        const { id } = req.params;
    ...
    // !!!!!!!!!!!!!!!
    this.leaveChat = (0, express_async_handler_1.default)((req, res, next) =>
      __awaiter(this, void 0, void 0, function* () {
        const { chatId } = req.body;
        const id = req.loggedUser._id; // logged user
        yield this.service.leaveChat(id, chatId);
